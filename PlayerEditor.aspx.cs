...
namespace netba
{
	...
	public partial class PlayerEditor : System.Web.UI.Page
	{
		...
		private void EnablePlayerPanel( int PlayerId )
		{
			...
			DataSet dsPositions = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
				"spGetPositions" );
			...
			DataSet dsTeams = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
				"spGetAllTeams" );
			...
			DataSet dsRealTeams = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
				"spGetRealTeams" );
			...
			if( PlayerId != -1 )
			{
				...
				DataSet dsPlayer = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
		...
		{
			DataSet dsPlayers = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
