<%@ Page Language="C#" MasterPageFile="~/Netba.master" AutoEventWireup="true" CodeFile="RealTeamView.aspx.cs"
    Inherits="RealTeamView" Title="NBA Team View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="Server">
    <asp:DataGrid ID="dgRoster" runat="server" CssClass="grid" AutoGenerateColumns="False">
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="PointAverage" HeaderText="NetPPG" 
