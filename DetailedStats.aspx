<%@ Page Language="C#" MasterPageFile="~/Netba.master" AutoEventWireup="true" CodeFile="DetailedStats.aspx.cs" Inherits="DetailedStats" Title="Detailed Stats" %>
...
<br />
    ...
    <Web:ChartControl ID="ccMovingAverage" runat="server" BorderStyle="Solid" BorderWidth="1px"
        ChartPadding="30" HasChartLegend="False" Height="330px" Padding="25"
        ShowTitlesOnBackground="False" Width="701px" YCustomEnd="0" YCustomStart="0"
        YValuesInterval="0" BottomChartPadding="40" XTicksInterval="3">
        ...
        <YTitle ForeColor="White" StringFormat="Near,Near,Character,LineLimit" Text="Points" />
						...
						<tr>
							...
							<asp:Label id="Label1" runat="server" Font-Size="Large">Season:</asp:Label>
                                ...
                                <br />
						    <asp:DataGrid id="dgSeasonData" runat="server" CssClass="grid" Font-Size="Smaller" AutoGenerateColumns="False">
						    ...
						    <td>
                                ...
                                <asp:DataGrid id="dgCareerData" runat="server" CssClass="grid" Font-Size="Smaller" AutoGenerateColumns="False">
								<HeaderStyle CssClass="gridheader"></HeaderStyle>
								<Columns>
                            ...
                            <asp:DataGrid id="dgBestGames" runat="server" CssClass="grid" Font-Size="Smaller" AutoGenerateColumns="False">
							    <HeaderStyle CssClass="gridheader"></HeaderStyle>
							    <Columns>
								    <asp:BoundColumn DataField="GameDate" HeaderText="Date" DataFormatString="{0:d}">
									    <ItemStyle HorizontalAlign="Left"></ItemStyle>
