...
namespace netba
{
	...
	public partial class BoxScore : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			DataSet dsGameInfo = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
			...
			// get the team boxes
			DataSet dsHome = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
				"spGetTeamContributions", gameid, hometeamid );	
			AddSummaryData( dsHome );
			dgHome.DataSource = dsHome;
			dgHome.DataBind();

			DataSet dsAway = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
