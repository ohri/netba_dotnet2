...
namespace netba
{
	...
	public partial class SelectPlayer : System.Web.UI.Page
	{
        ...
        private string getNextPickInfo( int PickId )
        {
            ...
            try
            {
                draftPickInfo = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ],
		...
		{
			DataSet playerInfo = SqlHelper.ExecuteDataset( System.Configuration.ConfigurationSettings.AppSettings[ "ConnectionString" ], 
